...
const DatasetUpload = () => {
  ...
  const handleFile = (file: File) => {
    ...
    // Simulate backend preprocessing
    setTimeout(() => {
      setIsProcessing(false);
      toast({ title: "File Ready", description: `${file.name} processed successfully!` });

      // Navigate to Analysis Options page
      navigate('/analysis', { state: { fileName: file.name } });
    }, 3000); // 3 sec preprocessing simulation
  };
        ...
        {!uploadedFile ? (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <Button onClick={openFileDialog} variant="outline" className="border-water-primary text-water-primary">
                Select File
              </Button>
          ...
          <div className="flex items-center gap-3 p-4 bg-secondary/50 rounded-lg border">
            ...
            {isProcessing && <div className="text-water-primary animate-spin">Processing...</div>}
          </div>
        )}
